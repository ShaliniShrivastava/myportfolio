        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-slate-900 w-full max-w-5xl rounded-3xl p-8 overflow-y-auto max-h-[90vh]">
            ...
            <div className="flex items-center justify-between mb-8">
              <h2 className="text-3xl font-bold text-white">Update Hero</h2>
            ...
            <form onSubmit={handleUpdate} className="grid md:grid-cols-2 gap-6">
              ...
              <div className="md:col-span-2 flex items-center gap-6">
                <img
                  src={image ? URL.createObjectURL(image) : hero?.profileImage}
                  alt=""
              ...
              <button className="bg-cyan-500 hover:bg-cyan-600 py-4 rounded-xl font-bold text-white md:col-span-2 transition">
                Update Hero
              </button>
            </form>
          </div>
